...
## 11. Matriz de figuras e tabelas

Esta matriz orienta onde encaixar elementos visuais no artigo e no relatorio tecnico. O criterio e simples: visual entra quando reduz texto repetitivo e ajuda a defender uma decisao metodologica.

| Visual | Onde entra | Funcao narrativa |
|---|---|---|
| Tabela SEER vs METABRIC | Introducao / Materiais e Metodos | Mostrar por que o METABRIC virou a trilha canonica e o SEER ficou como baseline corrigido |
...
### Prioridade de inclusao no artigo

1. Tabela comparativa SEER vs METABRIC.
2. Tabela de metricas principais.
3. Figura ou tabela do trade-off do ensemble.
4. Figura de explicabilidade principal.
5. Figura de calibracao.

### Prioridade de inclusao no relatorio tecnico

1. Tudo que entrar no artigo.
2. Dicionario de dados completo ou quase completo.
3. Tabelas de apoio para explicar features derivadas e cenarios de threshold.
4. Material de rastreabilidade da decisao metodologica.
