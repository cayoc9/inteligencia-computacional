# Prompt NotebookLM - Slide Deck v3

Use este prompt para gerar uma nova versao do slide deck no NotebookLM, com menos aparencia de template automatico e mais cara de defesa academica humana.
...
A abertura deve mostrar a tese do trabalho em vez de apenas o titulo.
...
Evite cara de documento convertido em slide.
...
- sem repetir o mesmo layout de dois cards identicos em muitos slides;
- sem cabecalhos com "Slide X";
- sem bullets demais;
- sem blocos de texto que parecam paragrafo de artigo;
- com assimetria controlada, hierarquia clara e 1 foco visual por slide.

## Composicoes desejadas

Use variedade de layouts:

- capa editorial com tese forte + comparacao SEER x METABRIC + pergunta central da defesa;
...
## Regras de composicao dos 4 slides principais

### Problema

- mostrar explicitamente por que falso negativo e mais critico;
- relacionar isso com a escolha de recall e F2;
- nao transformar o slide em aula teorica longa.

### Dataset

- mostrar que a troca para METABRIC foi uma troca de qualidade de sinal, nao de volume;
- deixar visivel que SEER tem mais registros, mas METABRIC tem variaveis clinicas mais relevantes;
- evitar grade simetrica vazia; usar contraste entre volume e profundidade clinica.

### Resultados

- usar numeros grandes;
- manter comparacao direta e rapida;
- deixar claro que METABRIC melhora antes do ensemble.

### Trade-off

- o slide deve mostrar na mesma tela FN e FP;
- a mensagem principal deve ser: sensibilidade alta tem custo operacional;
- evitar celebrar resultado sem ressalva.
...
## Regra de oralidade visual

Os slides devem parecer feitos para fala ao vivo, nao para leitura silenciosa.
...
- titulos com tese;
- apoio visual forte;
- no maximo 1 mensagem central por slide;
- nada que exija o publico ler um bloco inteiro para entender a figura.
