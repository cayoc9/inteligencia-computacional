...
\title{Breast Cancer Mortality Risk Classification:\\
Methodological Correction on SEER and Canonical Evolution to METABRIC}
...
Computational Intelligence projects in health require more than model training. They demand coherent problem framing, explicit leakage policy, defensible validation, and a careful interpretation of trade-offs. In this work, the selected problem is the classification of mortality outcome in breast cancer based on clinical tabular data, within the scope of a course requirement involving hybrid or ensemble intelligent systems. The framing is aligned with the current literature on breast-cancer survival prediction, which still reports technical pitfalls and uneven clinical feasibility in machine-learning pipelines~\cite{alsharif2021,feasibility2022}.
...
This result should be interpreted carefully. The ensemble was not the globally best discriminator in the SEER track. Instead, it represented an aggressive sensitivity-oriented operating point.
...
The canonical result is therefore much stronger than the SEER track not only in terms of headline performance, but also in terms of problem realism and feature support.
...
Future work includes formal survival modeling, local explainability analysis, broader repeated-validation protocols, and external validation on clinically closer cohorts.

\begin{thebibliography}{00}
\bibitem{curtis2012} C. Curtis \textit{et al.}, ``The genomic and transcriptomic architecture of 2,000 breast tumours reveals novel subgroups,'' \textit{Nature}, vol. 486, no. 7403, pp. 346--352, 2012.
\bibitem{metabricportal} cBioPortal, ``Breast Cancer (METABRIC, Nature 2012 \& Nat Commun 2016),'' accessed Jul. 3, 2026.
\bibitem{ensemble2010} M. M. Chaurasia and S. Pal, ``An ensemble machine learning approach to predict survival in breast cancer,'' \textit{Journal of Statistical Computation and Simulation}, 2010.
\bibitem{ensemble2022} A. R. et al., ``A machine learning ensemble approach for 5- and 10-year breast cancer survival prediction,'' \textit{Computers in Biology and Medicine}, 2022.
\bibitem{xai2024} S. A. et al., ``Explainable artificial intelligence in breast cancer detection and risk prediction: a systematic scoping review,'' 2024.
\bibitem{feasibility2022} T. M. et al., ``An assessment of the predictive performance of current machine learning-based breast cancer risk prediction models,'' \textit{Breast Cancer Research}, 2022.
\bibitem{alsharif2021} S. Alsharif \textit{et al.}, ``Predicting breast cancer 5-year survival using machine learning: a systematic review,'' 2021.
\end{thebibliography}
