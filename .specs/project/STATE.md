...
17. **Resultado METABRIC**: No fork clinico, o melhor modelo individual sem `survival_months` foi GradientBoosting com F2 0.7696, recall 0.7860 e PR AUC 0.7590. O ensemble threshold 0.25 atingiu F2 0.8885 e recall 0.9860, com 3 falsos negativos e 121 falsos positivos.
...
- **Trade-off do Ensemble METABRIC**: O threshold 0.25 reduziu falsos negativos para 3 no fork clinico, mas manteve 121 falsos positivos. Deve ser apresentado como cenario de alta sensibilidade.
...
- **Pendencia de Apresentacao/Relato Final**: O pipeline tecnico do Trabalho 2 esta executado, mas ainda resta consolidar narrativa final de apresentacao, PDF e defesa com comparacao SEER vs METABRIC.
